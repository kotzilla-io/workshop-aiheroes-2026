...
class JankStatsKoinModule {
    ...
    @ActivityScope
    fun jankStats(activity : ComponentActivity) : JankStats = JankStats.createAndTrack(activity.window, providesOnFrameListener())

    // WORKSHOP BUG #4
    @Singleton
    fun jankStatsRegistry() : JankStatsRegistry = JankStatsRegistry()
}
