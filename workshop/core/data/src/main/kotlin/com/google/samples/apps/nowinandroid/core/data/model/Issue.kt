...
/**
 * WORKSHOP HELPER — toggles intentionally introduced performance issues.
 *
 * Used by the workshop exercises to simulate blocking work (main-thread blocking,
 * slow startup, heavy background work). Kotzilla detects the resulting resolution /
 * thread issues at the component level — no manual instrumentation needed.
 */
object Issues {
