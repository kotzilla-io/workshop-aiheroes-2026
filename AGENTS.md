...
> ## ⚠️ Workshop rule for AI assistants — read first
...
-   **Dependency Injection:** Koin (with the Koin Compiler Plugin) is used for dependency injection throughout the app, simplifying the management of dependencies and improving testability.
